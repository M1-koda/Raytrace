...
```
第2引数は、正方形の座標(実数):正方形が通る座標
第3引数は、正方形の方線(任意の実数を','で区切り指定)
第4引数は、正方形の辺の長さ(実数)
第5引数は、正方形の色(0 ≦ x ≦ 255, 整数)
</details>
...
```
第2引数は、円の中心座標(任意の実数を','で区切り指定,実数)
第3引数は、円筒の方向ベクトル(任意の実数を','で区切り指定)
第4引数は、円筒の直径(実数)
第5引数は、円筒の長さ(実数)
第6引数は、円筒の色(0 ≦ x ≦ 255, 整数)
</details>
...
```
第2引数は、三角形の1点目座標(任意の実数を','で区切り指定,実数)
第3引数は、三角形の2点目座標(任意の実数を','で区切り指定,実数)
第4引数は、三角形の3点目座標(任意の実数を','で区切り指定,実数)
</details>
